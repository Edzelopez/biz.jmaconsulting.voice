...
<div id="help">
    {ts}These settings control tracking of calls. The number of recipients selected to receive this voice broadcast
        in shown in the box to the right. If this count doesn't match your expectations, click Previous to review your
        selection(s).
    {/ts}
</div>
