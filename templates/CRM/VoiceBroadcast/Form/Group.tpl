  ...
  <table class="form-layout">
   <tr class="crm-mailing-group-form-block-name"><td class="label">{$form.name.label}</td><td>{$form.name.html} {help id="mailing-name"}</td></tr>
    ...
    <tr class="crm-mailing-group-form-block-dedupeemail">
        <td class="label">{$form.is_public.label}</td>
        <td>{$form.is_public.html} {help id="is_public"}</td>
    </tr>

     <tr class="crm-mailing-group-form-block-dedupeemail">
        <td class="label">{$form.phone_location.label}</td>
        <td>{$form.phone_location.html} {help id="phone_location"}</td>
    </tr>

      <tr class="crm-mailing-group-form-block-dedupeemail">
        <td class="label">{$form.phone_type.label}</td>
        <td>{$form.phone_type.html} {help id="phone_type"}</td>
    </tr>
  </table>
...
<div class="crm-accordion-wrapper ">
 ...
 {if $context EQ 'search'}{ts}Additional Voice Broadcasting Recipients{/ts}{else}{ts}Voice Broadcasting Recipients{/ts}{/if}
