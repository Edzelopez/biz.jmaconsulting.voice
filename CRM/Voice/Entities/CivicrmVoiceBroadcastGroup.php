 ...
 *
 * @ORM\Table(name="civicrm_voice_broadcast_group", indexes={@ORM\Index(name="voice_id", columns={"voice_id", "entity_id"})})
 * @ORM\Entity
 */
class CRM_Voice_Entities_CivicrmVoiceBroadcastGroup
{
    /**
     * @var integer
     *
