...
/**
 * CivicrmVoiceBroadcastResponse
 *
 * @ORM\Table(name="civicrm_voice_broadcast_response", indexes={@ORM\Index(name="voice_id", columns={"job_id", "phone_id"}), @ORM\Index(name="contact_id", columns={"contact_id"})})
 * @ORM\Entity
 */
class CivicrmVoiceBroadcastResponse
{
    /**
     * @var integer
     *
